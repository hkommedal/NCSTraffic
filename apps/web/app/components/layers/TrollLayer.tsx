...
import { trollPolygon, trollField, trollFacilities } from "@/lib/data/troll";
...
export default function TrollLayer({
  facilityTypes,
}: {
      ...
      >
        <Popup>
          <div className="text-sm">
            <h3 className="text-base font-bold">{trollField.name}</h3>
            <p className="mt-1">
              <strong>Operator:</strong> {trollField.operator}
            </p>
            <p>
              <strong>Status:</strong> {trollField.status}
            </p>
            <p>
              <strong>Discovery:</strong> {trollField.discoveryYear}
            </p>
            <p>
              <strong>Production start:</strong> {trollField.productionStart}
            </p>
            <p>
              <strong>Water depth:</strong> {trollField.waterDepthM} m
            </p>
            <p className="mt-1 text-gray-600">{trollField.description}</p>
          </div>
        </Popup>
      </Polygon>
